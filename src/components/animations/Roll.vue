...
export default {
    ...
    return {
      ...
      paths: {
        ...
        two: [
          ...
          'M765.44,117.8c261.66-17.25,443.83-39.64,631.54-17.41,160.11,20.81,255.15,32.73,420.81,53.23l56.13,629.29s-283.16-53.35-436-78.53c-173.55-30.49-343-11.17-593,12.7-223.33,18.07-529,66.37-529,66.37,10.2-1.2,101.8-5.51,120.7-89.71,12.44-77.77,15-136.58,22.42-213C468.68,370.57,484.9,158.2,484.9,158.2S567,134.45,765.44,117.8Z',
  ...
  methods: {
    runAnimation(index, callback) {
      this.pathOne.animate({ d: this.paths.one[index] }, 1000, mina.easeinout);
      this.pathTwo.animate({ d: this.paths.two[index] }, 1000, mina.easeinout);
      this.pathThree.animate({ d: this.paths.three[index] }, 1000, mina.easeinout, callback);
    },
    scrollAnimate() {
