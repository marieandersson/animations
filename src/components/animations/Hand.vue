<template>
  <div class="hand">
    <svg v-on:click="forward" class="svg-hand" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 523 227">
...
export default {
  ...
  methods: {
    forward () {
      this.handPath.animate({ d: this.handPaths[1] }, 1500, mina.linear, this.back);
    },
    back () {
      this.handPath.animate({ d: this.handPaths[0] }, 1000, mina.linear);
    }
  },
  mounted () {
