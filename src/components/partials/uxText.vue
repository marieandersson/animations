  ...
  data () {
    return {
      ...
      texts: {
        ...
        scroll: 'Scroll animations are popular because they can be used on all devices. If you’re using fly-in animations when scrolling, try to use them sparingly so they don’t become overwhelming for the user. It’s also important to show the user that they can scroll down, either with a scroll icon or by letting some content from the next section be visible when the user is at the section above it.',
